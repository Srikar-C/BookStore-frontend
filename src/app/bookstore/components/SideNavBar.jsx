...
import { Section } from "@/utils/FunctionalUtils";
...
export default function SideNavBar() {
    ...
    return (
        <div className="main flex flex-col gap-3 py-4 px-3 bg-(--background) rounded-xl w-full h-full relative">
            ...
            <div className="sections flex flex-col gap-4">
                ...
                <section className="flex flex-col gap-3">
                    ...
                    <Section icon={<FaShoppingCart />} text="Carts" path="/bookstore/carts" click={handleCart} url={pathName} count={0} />
