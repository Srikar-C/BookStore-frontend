...
export default function BookCard({ book, user }) {
    ...
    return (
        ...
        `}>
            ...
            {/* Hover Details */}
            <div className={`absolute inset-0 flex translate-y-full flex-col justify-end bg-black/80 p-5 text-white backdrop-blur-sm transition-all duration-500 ${book.quantity <= 0 ? user.role == "USER" ? "cursor-not-allowed" : "group-hover:translate-y-0" : "group-hover:translate-y-0"} z-[12] rounded-2xl`}>
